...
from aether_hf.speed_levels import Modulation, BITS_PER_SYMBOL
...
CONSTELLATIONS = {
    ...
    Modulation.QAM32:  _qam_constellation(32) if 32 == int(np.sqrt(32))**2 else None,
...
class Demapper:
    ...
    def soft_demap(self, symbols: np.ndarray,
