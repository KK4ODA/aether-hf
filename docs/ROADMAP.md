...
21. **The documentation brought up to beta.68** (2026-09-26): README, user guides, the three
    specs, this roadmap, the contribution and maintenance guides. Owed: `field/LOG.md` rows for
    the sessions since 2026-09-17, which need the author's channel class for each path.
